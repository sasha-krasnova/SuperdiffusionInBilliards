...
namespace SuperdiffusionInBilliards
{
    ...
    {
        private List<StateOfParticleDetailed> statistics;
        private int statIdx;
        private Graphics gr;
        private Pen p;
        ...
        public DrawingForm(List<StateOfParticleDetailed> statistics, Point2D latticeSize) : this()
        {
        ...
        private void timer1_Tick(object sender, EventArgs e)
        {
            try
            {
                ...
                StateOfParticleDetailed stat = statistics[statIdx];
